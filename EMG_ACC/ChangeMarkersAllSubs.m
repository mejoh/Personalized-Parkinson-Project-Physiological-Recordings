...
if strcmp(Task, "motor")
    ...
    settings.NewFolder  = fullfile(pfProject, "3022026.01", "analyses", "EMG", "motor", "corrected");                 %Output folder for the new files
...
elseif strcmp(Task, "reward")
    ...
    settings.NewFolder  = fullfile(pfProject, "3022026.01", "analyses", "EMG", "reward", "corrected");                 %Output folder for the new files
...
elseif strcmp(Task, "rest")
    ...
    settings.NewFolder  = fullfile(pfProject, "3022026.01", "analyses", "EMG", "rest", "corrected");                 %Output folder for the new files
    settings.NumberOfEchos = 1;                                                      % Number of Echos if you do not have a multi echo sequence, use 1.
end
